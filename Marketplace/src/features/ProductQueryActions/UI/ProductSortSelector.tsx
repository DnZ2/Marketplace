...
const ProductSortSelector: FC<Props> = ({className,...props}) => {
    ...
    return (
        <Select ref={triggerRef} className="bg-white w-[220px] rounded-md">
            <SelectTrigger onMouseDown={handleToggleSelect}>
                <SelectValue ref={searchRef} className={className} {...props} value={selectedOption} readOnly onFocus={handleFocusSelect}/>
