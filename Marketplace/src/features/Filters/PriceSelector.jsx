...
function PriceSelector ({diapason, submit})  {
  ...
  return (
	<div autoComplete="off" className="flex items-center gap-4">
		<input className="p-2 rounded" type="number" value={minPriceValue} onChange={handleChangeMinPrice} placeholder={`from ${diapason?.from}`} />
